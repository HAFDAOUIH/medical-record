...
module.exports = {
  networks: {
    development: {
      ...
      port: 7545,           // Ganache's default RPC server port
      ...
      from: "0x50E673c2478bfd59579AE0EFC3B17FF370D67f98", // (Optional) Make sure this is set to the address you want to deploy from.
    },
  },
